...
export const Simulator: React.FC = () => {
  ...
  return (
    <div id="simulator" className="relative pb-20 lg:pb-0">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
        ...
        <div id="results-panel" className="lg:col-span-5 lg:sticky lg:top-20">
          <ResultsPanel
            period={period}
      ...
      <div
        ...
        className="fixed bottom-0 left-0 right-0 z-40 bg-surface-raised/95 backdrop-blur-md border-t border-border shadow-lg px-4 py-2.5 flex items-center justify-between gap-3 text-xs lg:hidden"
      >
        ...
        <a
          href="#results-panel"
          className="shrink-0 px-2.5 py-1 rounded-md bg-surface border border-border text-[11px] font-semibold text-ink hover:bg-surface-subtle transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
          View Details
        </a>
      </div>
